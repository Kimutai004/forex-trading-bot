...
Generated on: 2024-11-30 12:43:43
...
├── trading_logs/
├── .gitignore
├── PROJECT_STRUCTURE_20241130_124343.md
├── README.md
├── config.json
├── forex_bot.py
...
def test_imports():
    try:
        ...
        from src.signals.evaluator import SignalEvaluator
        from src.signals.providers.moving_average import MovingAverageProvider
...
if __name__ == "__main__":
    ...
    print(f"Functionality: {'✅' if imports_ok and functionality_ok else '❌'}")
```
...
```json
{
    ...
    "last_modified": "2024-11-30 12:29:31",
...
### core\ftmo_rule_manager.py (8.79 KB)
...
### signals\__init__.py (230.00 B)

```py
from ..src.signals.providers.base import Signal, SignalType, SignalProvider
from ..src.signals.providers.manager import SignalManager
...
### src\core\market\sessions.py (4.33 KB)
...
### src\core\market\watcher.py (10.25 KB)
...
### src\core\system\auditor.py (22.15 KB)
...
### src\core\system\system_auditor.py (22.15 KB)
...
### src\core\trading\mt5.py (29.70 KB)
...
### src\signals\__init__.py (306.00 B)

```py
from .manager import SignalManager
from .evaluator import SignalEvaluator
from .providers import SignalProvider, Signal, SignalType, MovingAverageProvider
...
### src\signals\providers\__init__.py (207.00 B)

```py
from .base import SignalProvider, Signal, SignalType
from .moving_average import MovingAverageProvider
...
### src\utils\trading_logger.py (7.32 KB)
